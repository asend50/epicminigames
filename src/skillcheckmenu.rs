...
By: <Asen Doiron>
Date: 2026-06-05
Program Details: <Menu for the skill check minigame.>
*/
...
let backgroundcolor = Color::from_hex(0xFFA8E9);
    ...
    loop {
        ...
        if is_key_pressed(KeyCode::Space) {
            return ("skillcheck".to_string(), tm, chickenclickerscore, gemcollectorscore, skillcheckpoints, fourcournersscore);
        }
