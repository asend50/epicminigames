...
By: <Asen Doiron>
Date: 2026-06-05
Program Details: <Menu for the gem collector minigame.>
*/
...
let backgroundcolor = Color::from_hex(0xAD81C7);
    ...
    loop {
        ...
        if is_key_pressed(KeyCode::Space) {
            return ("gemcollector".to_string(), tm, chickenclickerscore, gemcollectorscore, skillcheckpoints, fourcournersscore);
        }
