...
pub async fn run(tm: TextureManager, chickenclickerscore: i32, gemcollectorscore: i32, skillcheckpoints: i32, fourcournersscore: i32) -> (String, TextureManager, i32, i32, i32, i32) {
    ...
    let btn_chicken = ImageButton::new(
        450.0,  // width
        750.0,  // height
        250.0,  // x position
        250.0,   // y position
    ...
    loop {
        ...
        if btn_arrowbutton.click() {
            return ("clickermenu".to_string(), tm, chickenclickerscorevalue, gemcollectorscore, skillcheckpoints, fourcournersscore);
        }
        ...
        if btn_chicken.click() {
            ...
            if chickenpoints == 100 {
                ...
                return ("menu".to_string(), tm, chickenclickerscorevalue, gemcollectorscore, skillcheckpoints, fourcournersscore);
        }
