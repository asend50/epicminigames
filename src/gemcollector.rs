...
// Speed of movement in pixels per second
    ...
    loop {
        ...
        if btn_arrowbutton.click() {
            return ("gemcollectormenu".to_string(), tm, chickenclickerscore, gemcollectorscorevalue, skillcheckpoints, fourcournersscore);
        }
// player movement
    ...
    return ("menu".to_string(), tm, chickenclickerscore, gemcollectorscorevalue, skillcheckpoints, fourcournersscore);
    }
