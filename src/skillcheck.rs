...
let bordercolorred = Color::from_hex(0xE04A4A);
    ...
    loop {
        ...
        if btn_arrowbutton.click() {
            return ("skillcheckmenu".to_string(), tm, chickenclickerscore, gemcollectorscore, skillcheckpointsvalue, fourcournersscore);
        }
        ...
        let mut pos = blackbar.pos();
            ...
            if skillcheckscore == 25 {
                ...
                return ("menu".to_string(), tm, chickenclickerscore, gemcollectorscore, skillcheckpointsvalue, fourcournersscore);
            }
